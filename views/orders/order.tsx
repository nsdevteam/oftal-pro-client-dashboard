          ...
          return (
            ...
            >
              <Button
                ...
                bg={selectAddress === addressItem ? '#F2F2F2' : 'transparent'}
                variant="primary"
              >
                <Box>
                  {province}, {city},{' '}
                ...
                <Box
                  ...
                  height="20px"
                  borderRadius="25px"
                  bg={selectAddress === addressItem ? '#4763E4' : 'transparent'}
                />
              </Button>
            </Box>
          );
          ...
          >
            ...
            <Input
              ...
              {...register('address.province', {
                ...
                maxLength: {
                  value: 16,
                  message: 'Campo província deve ter no máximo 16 caracteres',
                },
                minLength: {
                  value: 6,
                  message: 'Campo província deve ter no mínimo 4 caracteres',
                },
              })}
              nFocus={{
                borderColor: '#4763E4',
          ...
          >
            ...
            <Input
              ...
              {...register('address.state', {
                ...
                maxLength: {
                  value: 16,
                  message: 'Campo município deve ter no máximo 16 caracteres',
                },
                minLength: {
                  value: 6,
                  message: 'Campo município deve ter no mínimo 4 caracteres',
                },
              })}
              nFocus={{
                borderColor: '#4763E4',
          ...
          >
            ...
            <Input
              ...
              {...register('address.city', {
                ...
                maxLength: {
                  value: 16,
                  message: 'Campo bairro deve ter no máximo 10 caracteres',
                },
              })}
              nFocus={{
                borderColor: '#4763E4',
        ...
        <Box as="div" marginTop="2rem" padding="0.5rem">
          ...
          >
            <Box
              ...
              alignItems="center"
              padding="1rem"
              border={`1px solid ${paymentByReference ? '#4763E4' : '#E4E4E7'}`}
              borderRadius="M"
              mr={['NONE', 'S']}
              ml={['NONE', 'S']}
              minWidth={['100%', '10rem']}
            ...
            <Box
              ...
              padding="1rem"
              borderRadius="M"
              border={`1px solid ${paymentByExpress ? '#4763E4' : '#E4E4E7'}`}
              mr={['NONE', 'S']}
              ml={['NONE', 'S']}
              minWidth={['100%', '10rem']}
              width={['34rem']}
